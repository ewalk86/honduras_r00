...
stove_use_compliance <- r00_full_long %>% 
...
################################################################
##### model with mean_temp
model_temp <- lmer(outcome ~ stove_use_3 + ns(date_sphygmo, df=6) + age_baseline +
...
model_full <- lmer(outcome ~ stove_use_3 + ns(date_sphygmo, df=6) + age_baseline +
