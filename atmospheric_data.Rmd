...
boxplot_data <- r00_full_long %>% 
  select(ambient_pm, ambient_bc, ambient_oc, temp_c, temp_rolling_24)
...
boxplot(log(as.numeric(boxplot_data$ambient_pm)))
...
boxplot(log(as.numeric(boxplot_data$ambient_bc)))
...
boxplot(log(as.numeric(boxplot_data$ambient_oc)))
...
boxplot(as.numeric(boxplot_data$temp_c))
boxplot(log(as.numeric(boxplot_data$temp_c)))
...
boxplot(as.numeric(boxplot_data$temp_rolling_24))
boxplot(log(as.numeric(boxplot_data$temp_rolling_24)))
```
