...
```{r}
smoke_summary <- r00_full_joined_sphygmocor %>% 
...
## Phases 1 and 2 only
```{r}
cat_summary_stats <- r00_full_joined_sphygmocor %>% 
  filter(phase == 1 | phase == 2) %>% 
  select(phase, study_arm, aug_index, school_bi, age_baseline,
