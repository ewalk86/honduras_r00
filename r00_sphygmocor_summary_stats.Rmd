...
summary_aix_subgroups <- r00_56_combined %>% 
  ...
  summarise("Mean AIx" = mean(aug_index, na.rm = TRUE),
...
# Those with negative difference started with lower AIx (P1), and were more likely
# to miss phase 2 than those without a negative difference. They are also 4.5 years
# younger on average, weigh 6 lbs more (bmi 1 unit higher). SES factors are similar,
# however, weighted SES sum is higher (5.8 vs 3.7) in those with neg diff in AIx.
# They were more likely to take bp meds (18 vs 8), although BP was similar in both groups.

# Arm 2 had more people who missed phases than Arm 1 - could be r/t intervention?
# AIx was slightly lower in Arm 2 than Arm 1 (20.5 vs 21)
# Participants were more likely to drop out as the study went on
## 18 fewer in P6 than in P1
# Those assigned to Traditional and Justa were essentially the same
## Where was it grouped differently to create a bias?
###
```
