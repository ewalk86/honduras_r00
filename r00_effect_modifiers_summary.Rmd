...
metsyn_bp <- table(r00_metsyn$met_syn, r00_bp$bp_cat)
kable(prop.table(metsyn_bp))

metsyn_hba1c <- table(r00_metsyn$met_syn, r00_hba1c$hba1c_cat)
kable(prop.table(metsyn_hba1c))

whr_waist <- table(r00_whr$whr_cat, r00_waist$waist_cat)
kable(prop.table(whr_waist))

whr_bmi <- table(r00_whr$whr_cat, r00_bmi$bmi_cat)
kable(prop.table(whr_bmi))

waist_bmi <- table(r00_waist$waist_cat, r00_bmi$bmi_cat)
