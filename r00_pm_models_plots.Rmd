...
# Simple linear models at Phase 1
```{r}
# AIx, area pm
aix_model_apm_p1 <- lm(aug_index ~ log_a_twa + age_baseline +
                       whr + phys_act + dds_total + beds_new +
                       ses_materials + school_self, 
                       r00_model_data_baseline)
summary(aix_model_apm_p1)
tidy(aix_model_apm_p1, conf.int = TRUE)

# AIx, personal pm
aix_model_ppm_p1 <- lm(aug_index ~ log_p_twa + age_baseline +
                       whr + phys_act + dds_total + beds_new +
                       ses_materials + school_self, 
                       r00_model_data_baseline)
summary(aix_model_ppm_p1)
tidy(aix_model_ppm_p1, conf.int = TRUE)

# CPP, area pm
cpp_model_apm_p1 <- lm(pulse_pressure_central ~ log_a_twa + age_baseline +
                       whr + phys_act + dds_total + beds_new +
                       ses_materials + school_self, 
                       r00_model_data_baseline)
summary(cpp_model_apm_p1)
tidy(cpp_model_apm_p1, conf.int = TRUE)

# CPP, personal pm
cpp_model_ppm_p1 <- lm(pulse_pressure_central ~ log_p_twa + age_baseline +
                       whr + phys_act + dds_total + beds_new +
                       ses_materials + school_self, 
                       r00_model_data_baseline)
summary(cpp_model_ppm_p1)
tidy(cpp_model_ppm_p1, conf.int = TRUE)
```
