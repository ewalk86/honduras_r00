...
itt_combined <- rbind(itt_sbp_tidy, itt_dbp_tidy, itt_aix_tidy, itt_cpp_tidy)
...
itt_plot_estimates <- itt_combined %>%
  ...
  geom_point(aes(x=model, y=estimate, color = model), 
  ...
  annotate(geom = "table", x = 7, y = 2, label = list(obs_combined),
           color = "black", fill = "white", size = 6)
itt_plot_estimates

# Save plot as jpg
ggsave("itt_plot_estimates.jpg", width = 12, height = 6.5)
```
