...
write_rds(r00_full_new, "output/r00_health_pm_joined.rds")
write_csv(r00_full_new, "output/r00_health_pm_joined.csv", na = " ")

write_rds(r00_full_new, "output/r00_full_repeated_by_phase.rds")
write_csv(r00_full_new, "output/r00_full_repeated_by_phase.csv", na = " ")
```
