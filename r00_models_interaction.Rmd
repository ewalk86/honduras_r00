...
############################################################
model_int <- lmer(outcome ~ assigned_stove*season + kitchen_temp +
                          ns(date_sphygmo, df=6) + (1 | house_id), r00_model_data)
summary(model_int)
int_emmeans <- emmeans(model_int, pairwise ~ assigned_stove | season)
