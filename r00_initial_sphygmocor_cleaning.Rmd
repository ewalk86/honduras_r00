...
# Check that aug_index pulled from sphygmocor matches aix entered into ODK in the field
```{r}
data_check <- r00_full_joined_sphygmocor %>% 
  select(house_id, aix, aug_index) %>% 
