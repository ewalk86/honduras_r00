...
model_apm_temp <- lmer(outcome ~ log_a_twa + ns(date_sphygmo, df=6) + age_baseline +
                       waist_cm + school_bi + temp_max_previous +
                       (1 | house_id), r00_model_data)
...
model_p1 <- lm(outcome ~ log_a_twa + temp_max_previous +
...
model_p2 <- lm(outcome ~ log_a_twa + temp_max_previous +
...
model_p3 <- lm(outcome ~ log_a_twa + temp_max_previous +
...
model_p4 <- lm(outcome ~ log_a_twa + temp_max_previous +
...
model_p5 <- lm(outcome ~ log_a_twa + temp_max_previous +
...
model_p6 <- lm(outcome ~ log_a_twa + temp_max_previous +
...
model_rainy <- lmer(outcome ~ log_a_twa + temp_max_previous +
                   age_baseline + waist_cm + school_bi +
...
model_dry <- lmer(outcome ~ log_a_twa + temp_max_previous +
                   age_baseline + waist_cm + school_bi +
...
model_p1 <- lm(outcome ~ log_p_twa + temp_max_previous +
                   age_baseline + waist_cm + school_bi , phase_1)
# summary(model_p1)
tidy_model_p1 <- tidy(model_p1, conf.int = TRUE) %>% 
    filter(grepl('log_p_twa', term)) %>%  
...
model_p2 <- lm(outcome ~ log_p_twa + temp_max_previous +
                   age_baseline + waist_cm + school_bi , phase_2)
# summary(model_p2)
tidy_model_p2 <- tidy(model_p2, conf.int = TRUE) %>% 
    filter(grepl('log_p_twa', term)) %>%  
...
model_p3 <- lm(outcome ~ log_p_twa + temp_max_previous +
                   age_baseline + waist_cm + school_bi , phase_3)
# summary(model_p3)
tidy_model_p3 <- tidy(model_p3, conf.int = TRUE) %>% 
    filter(grepl('log_p_twa', term)) %>%  
...
model_p4 <- lm(outcome ~ log_p_twa + temp_max_previous +
                   age_baseline + waist_cm + school_bi , phase_4)
# summary(model_p4)
tidy_model_p4 <- tidy(model_p4, conf.int = TRUE) %>% 
    filter(grepl('log_p_twa', term)) %>%  
...
model_p5 <- lm(outcome ~ log_p_twa + temp_max_previous +
                   age_baseline + waist_cm + school_bi , phase_5)
# summary(model_p5)
tidy_model_p5 <- tidy(model_p5, conf.int = TRUE) %>% 
    filter(grepl('log_p_twa', term)) %>%  
...
model_p6 <- lm(outcome ~ log_p_twa + temp_max_previous +
                   age_baseline + waist_cm + school_bi , phase_6)
# summary(model_p6)
tidy_model_p6 <- tidy(model_p6, conf.int = TRUE) %>% 
    filter(grepl('log_p_twa', term)) %>%  
...
model_rainy <- lmer(outcome ~ log_p_twa + temp_max_previous +
                   age_baseline + waist_cm + school_bi +
                   ns(date_sphygmo, df=6) + (1 | house_id), season_rainy)
# summary(model_rainy)
tidy_model_rainy <- tidy(model_rainy, conf.int = TRUE) %>% 
...
model_dry <- lmer(outcome ~ log_p_twa + temp_max_previous +
                   age_baseline + waist_cm + school_bi +
                   ns(date_sphygmo, df=6) + (1 | house_id), season_dry)
# summary(model_dry)
tidy_model_dry <- tidy(model_dry, conf.int = TRUE) %>% 
