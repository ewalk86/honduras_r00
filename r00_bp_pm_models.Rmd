...
model_apm_full <- lmer(outcome ~ log_a_twa + ns(date_sphygmo, df=6) + age_baseline +
                       ...
                       ses_materials + beds_new + salt_cat + sugar_cat +
                       manteca_cat + caffeine_today + breakfast +
                       kitchen_temp + temp_c +
                       (1 | house_id), r00_model_data)
...
model_p1 <- lm(outcome ~ log_a_twa + temp_c +
...
model_p2 <- lm(outcome ~ log_a_twa + temp_c +
...
model_p3 <- lm(outcome ~ log_a_twa + temp_c +
...
model_p4 <- lm(outcome ~ log_a_twa + temp_c +
...
model_p5 <- lm(outcome ~ log_a_twa + temp_c +
...
model_p6 <- lm(outcome ~ log_a_twa + temp_c +
...
model_rainy <- lmer(outcome ~ log_a_twa + temp_c +
                   age_baseline + waist_cm + school_bi +
...
model_dry <- lmer(outcome ~ log_a_twa + temp_c +
                   age_baseline + waist_cm + school_bi +
...
model_ppm <- lmer(outcome ~ log_p_twa + age_baseline + 
...
#int_emtrends <- emtrends(model_ppm, pairwise ~ age_cat_50, var = "log_p_twa")
...
############################################################
##### ITT model - using joined bp data (sphygmo and manual during visit 2)
model_ppm_bpjoined <- lmer(sys_bp_joined ~ log_p_twa + ns(date_sphygmo, df=6) + age_baseline + 
                      waist_cm + school_bi + (1 | house_id), r00_model_data)
...
model_ppm_full <- lmer(outcome ~ log_p_twa + ns(date_sphygmo, df=6) + age_baseline +
                       waist_cm + school_bi + dds_total + phys_act + bmi_cat +
                       ses_materials + beds_new + salt_cat + sugar_cat +
                       manteca_cat + caffeine_today + breakfast +
                       kitchen_temp + temp_c + 
                       (1 | house_id), r00_model_data)
