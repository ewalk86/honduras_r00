...
pm_plot_estimates <- all_pm_combined %>%
  ...
  theme_bw() +  
  geom_hline(yintercept = 0) +
  ggtitle(label = "Results for ER framework, PM2.5") +
  labs(y = "Estimate per log unit increase in PM") +
  labs(x = "", group = "", shape = "") +
  theme(title = element_text(size = 16), 
...
# Save plot as jpg
#ggsave("pm_plot_estimates.jpg", width = 12, height = 6)
...
bc_plot_estimates <- all_bc_combined %>%
  ...
  theme_bw() +  
  geom_hline(yintercept = 0) +
  ggtitle(label = "Results for ER framework, BC") +
  labs(y = "Estimate per log unit increase in BC") +
  labs(x = "", group = "", shape = "") +
  theme(title = element_text(size = 16), 
          axis.text.x = element_text(size = 16, colour = "black", angle = 45,
                                     hjust = 1, vjust = .8),
...
# Save plot as jpg
#ggsave("bc_plot_estimates.jpg", width = 12, height = 6)
```
