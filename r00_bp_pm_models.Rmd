...
r00_full_long <- read_csv("input/r00_full_dataset_01Mar2021_jpk.csv")
...
##### Kitchen PM all data
# run and save model
# also try with: pred_log_a_twa_LTA
model_apm <- lmer(outcome ~ pred_log_a_twa_LTA + ns(date_sphygmo, df=3) + 
                   age_baseline + waist_cm + school_bi + (1 | assigned_stove:house_id), r00_model_data)
#summary(model_apm)
...
# Also try with: pred_log_p_twa_LTA
model_ppm <- lmer(outcome ~ pred_log_p_twa_LTA + age_baseline + 
