...
```{r}
# Function for outcome = AIx and numeric/continuous predictor variables
...
aix_numeric_function(df = r00_model_data, term_fun = phys_act,
                       label_fun = "phys_act")
```
...
```{r}
# Function for outcome = CPP and numeric/continuous predictor variables
...
```{r}
# Function for outcome = CPP and categorical predictor variables
