...
### Data from phase 1 and 2
```{r}
summary_stats_age_cat <- r00_full_joined_sphygmocor %>% 
...
### Data from phase 1 and 2
```{r}
summary_stats_bmi_cat <- r00_full_joined_sphygmocor %>% 
...
```{r}
all_6_phases <- r00_full_joined_sphygmocor %>% 
...
# AIx75
aix75_histogram <- r00_full_joined_sphygmocor %>%
...
```{r}
# AIx
line_plots <- r00_full_joined_sphygmocor %>% 
