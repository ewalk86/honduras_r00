...
r00_data_sphygmo_p2 <- stove_use_data %>%
  # removes 6 observations for participant who wasn't assigned to a study arm
  filter(!is.na(study_arm)) %>% 
...
stove_use_compliance <- r00_model_data_outliers_removed %>% 
...
# Stove use analyses for AIx and CPP
```{r}
...
model_spline3 <- lmer(aug_index ~ stove_use_3 + 
...
model_confounders <- lmer(aug_index ~ stove_use_3 + ns(date_sphygmo, df=6) + 
...
################################################################
##### model with potential ambient confounders
# Try: temp_c, temp_rolling_24, temp_max_previous, temp_max, kitchen_temp,
# ambient_pm, ambient_bc, ambient_oc
model_ambient <- lmer(aug_index ~ stove_use_3 + ns(date_sphygmo, df=6) + 
                      age_baseline + waist_cat + school_bi +
                      temp_c + 
                      (1 | house_id), stove_use_data)
...
plot_estimates <- aix_results_3level %>%
  ...
  theme_bw() +  
  #ggtitle(label = "AIx stove use analysis: 3 level") +
...
plot_estimates <- aix_results_4level %>%
  ...
  geom_hline(yintercept = 0) +
  theme_bw() +  
  ggtitle(label = "AIx stove use analysis: 4 level") +
  labs(y = "Estimate vs traditional stove with \n or without secondary stove (%)") +
  labs(x = "") +
  theme(title = element_text(size = 16),
...
plot_estimates <- aix_results_days %>%
  ...
  geom_hline(yintercept = 0) +
  theme_bw() +  
  ggtitle(label = "AIx stove use analysis: days/month") +
  labs(y = "Estimate vs traditional stove with \n or without secondary stove (%)") +
  labs(x = "") +
  theme(title = element_text(size = 16),
          legend.position = "right",
...
plot_estimates <- aix_results_hours %>%
  ...
  geom_hline(yintercept = 0) +
  theme_bw() +  
  ggtitle(label = "AIx stove use analysis: hours/day") +
...
plot_estimates <- tidy_model_compliance %>%
  ...
  geom_hline(yintercept = 0) +
  theme_bw() +  
  ggtitle(label = "AIx stove use analysis: compliance") +
...
################################################################
##### date spline with 3 df
model_spline3 <- lmer(pulse_pressure_central ~ stove_use_3 + 
                           ns(date_sphygmo, df=3) + age_baseline +
                           waist_cm + school_bi + (1 | house_id), 
                           stove_use_data)
#summary(model_spline3)
...
################################################################
##### full model with all potential confounders
model_confounders <- lmer(pulse_pressure_central ~ stove_use_3 + 
...
# Try: temp_c, temp_rolling_24, temp_max_previous, temp_max, kitchen_temp,
# ambient_pm, ambient_bc, ambient_oc
model_ambient <- lmer(pulse_pressure_central ~ stove_use_3 + ns(date_sphygmo, df=6) + 
...
plot_estimates <- cpp_results_3level %>%
  ...
  geom_hline(yintercept = 0) +
  theme_bw() +  
  #ggtitle(label = "CPP stove use analysis: 3-level") +
...
plot_estimates <- cpp_results_4level %>%
  ...
  geom_hline(yintercept = 0) +
  theme_bw() +  
  ggtitle(label = "CPP stove use analysis: 4-level") +
...
plot_estimates <- cpp_results_days %>%
  ...
  geom_hline(yintercept = 0) +
  theme_bw() +  
  ggtitle(label = "CPP stove use analysis: days/month") +
  labs(y = "Estimate vs traditional stove with or \n without secondary stove (mmHg)") +
  labs(x = "") +
  theme(title = element_text(size = 16),
          legend.position = "right",
...
plot_estimates <- cpp_results_hours %>%
  ...
  geom_hline(yintercept = 0) +
  theme_bw() +  
  ggtitle(label = "CPP stove use analysis: hours/day") +
...
plot_estimates <- tidy_model_compliance %>%
  ...
  geom_hline(yintercept = 0) +
  theme_bw() + 
  ggtitle(label = "CPP stove use analysis: compliance") +
  labs(y = "Estimate vs compliant \n stove users (mmHg)") +
  labs(x = "") +
  theme(title = element_text(size = 16),
          legend.position = "right",
