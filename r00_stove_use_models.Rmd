...
r00_model_data_meds <- r00_data_6phases %>% 
...
aix_results <- rbind(tidy_model_6phases,
                     tidy_model_5phases,
...
plot_estimates <- aix_results %>%
  mutate(model = factor(model, levels = c("complete case", "missed phase", "all data", 
...
cpp_results <- rbind(tidy_model_6phases,
                     tidy_model_5phases,
                     tidy_model_stove_use_3,
                     tidy_model_no_bp_meds,
                     tidy_model_phase,
