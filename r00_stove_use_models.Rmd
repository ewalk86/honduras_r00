...
model_temp <- lmer(aug_index ~ stove_use_3 + ns(date_sphygmo, df=6) + 
                   age_baseline + waist_cm + school_bi +  
                   log(ambient_bc) + temp_c +
                   (1 | house_id), stove_use_data)
#summary(model_temp)
...
# Try: temp_c, temp_rolling_24, temp_max_previous, temp_max, kitchen_temp,
# ambient_pm, ambient_bc, ambient_oc
model_temp <- lmer(pulse_pressure_central ~ stove_use_3 + ns(date_sphygmo, df=6) + 
                   age_baseline + waist_cm + school_bi +  
                   temp_c +
                   (1 | house_id), stove_use_data)
#summary(model_temp)
