...
plot_estimates <- aix_results_3level %>%
  mutate(model = factor(model, levels = c("all data", "complete case", "missed phase", 
                                          "missed phase 2", 
                                          "no bp meds", "phase", "season", "spline 12 df", 
