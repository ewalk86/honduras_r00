...
# load full dataset
r00_full_long <- read_csv("input/r00_full_dataset_31oct2019_by.csv")
...
r00_model_data <- r00_full_long %>% 
  ...
  mutate(assigned_stove_2 = factor(assigned_stove, levels = c("Traditional", "Justa"))) %>% 
  mutate(stove_use_3.2 = factor(stove_use_3, 
